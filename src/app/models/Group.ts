...
export class Group {
  ...
  constructor(
      ...
      public player1centralId: number,
      public player2centralId: number,
      public player3centralId: number,
      public player4centralId: number,
      public playerSelectedId: number
  ) {}
