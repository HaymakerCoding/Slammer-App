...
export class QuoteService {
  ...
  getAllQuotes(eventId: number) {
    ...
    const URL = environment.API_URL + 'slammer-tour/quotes/get-all-for-event/index.php';
  ...
  add(eventId: number, playerId, type, text, slammer) {
    ...
    const URL = environment.API_URL + 'slammer-tour/quotes/add/index.php';
  ...
  delete(id, eventId: string) {
    ...
    const URL = environment.API_URL + 'slammer-tour/quotes/delete/index.php';
  ...
  update(id, playerId, type, text, slammer, eventId) {
    const headers = this.authService.getAuthHeader();
    const URL = environment.API_URL + 'slammer-tour/quotes/update/index.php';
