...
export class SummaryService {
  ...
  getAll(eventId) {
    ...
    const URL = environment.API_URL + 'slammer-tour/events/summary/get-all/index.php';
  ...
  add(eventId, text, type) {
    ...
    const URL = environment.API_URL + 'slammer-tour/events/summary/add/index.php';
  ...
  update(id, text, type, eventId) {
    const headers = this.authService.getAuthHeader();
    const URL = environment.API_URL + 'slammer-tour/events/summary/update/index.php';
  ...
  delete(id, type, eventId) {
    ...
    const URL = environment.API_URL + 'slammer-tour/events/summary/delete/index.php';
